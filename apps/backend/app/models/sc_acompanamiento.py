...
class AcompanamientoSeguro(Base):
    ...
    estado: Mapped[str] = mapped_column(
        EstadoAcompanamientoEnum, nullable=False, server_default="PENDIENTE"
    )
...
class UbicacionTrayecto(Base):
    ...
    acomp_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("sc_acompanamiento.acompanamiento_seguro.id", ondelete="CASCADE"),
        nullable=False,
    )
